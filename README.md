...
- **Vanilla CSS** (Custom Industrial SaaS Styling)
- **JavaScript** (Core Logic & Animations)
- **Space Grotesk & Inter** (Google Fonts)

## Credits

Rights go to **404 Founders Not Found**.  
Developed and refined by **Aswin C** and **Abdul Kalam Azad A**.

---

_Architected for industrial resilience and digital scale._
